...
function AdminLogin() {
    ...
    const handleLogin = (e)=>{
        ...
        if (email !== "admin@hrm.com" || password !== "admin123") {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Invalid admin credentials (use admin@hrm.com / admin123)");
            return;
        }
        setIsLoading(true);
        // Mock API Call
        setTimeout(()=>{
            setIsLoading(false);
            login("admin", email);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Admin login successful");
...
//# sourceMappingURL=src_0i3ek-d._.js.map