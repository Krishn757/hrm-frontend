...
function EmployeeLogin() {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "EmployeeLogin.useAuthStore[login]": (state)=>state.login
    }["EmployeeLogin.useAuthStore[login]"]);
    const handleLogin = (e)=>{
        e.preventDefault();
        if (!email || !password) {
        ...
        setTimeout(()=>{
            ...
            if (email.includes("admin")) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Admins should login from the Admin Portal");
                return;
            }
...
_s(EmployeeLogin, "f7yVaT+pxwtakzDRLsNJR81IZ3c=", false, function() {
    return [
...
_c = EmployeeLogin;
var _c;
__turbopack_context__.k.register(_c, "EmployeeLogin");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_1xcq9u8._.js.map